...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        restaurantRepository.save(new Restaurant("mcdonalds@gmail.com", "1234", 23092342, "portones", "10", "22", "carrasco", "26001122", "blabla"));
        restaurantRepository.save(new Restaurant("burgerking@gmail.com", "4321", 1234123, "arocena", "10", "22", "carrasco", "26002211", "blabla"));
    }
}
