...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        restaurantRepository.save(new Restaurant("Mc", "1234", "mcdonalds@gmail.com", "portones", 10, 22, "carrasco", "26001122", "tarjeta", "comida rapida", "blabla"));
        restaurantRepository.save(new Restaurant("Bk", "4321", "burgerking@gmail.com", "arocena", 10, 22, "carrasco", "26002211", "tarjeta", "comida rapida", "blabla"));
    }
}
